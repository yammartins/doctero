 ...
 */
export const value: Value = (target, ...args) => typeof target === 'function'
  ? target(...args)
  : target;
 ...
 * or if it's null.
 */
export const dot: Dot = (target, path, def = null, shouldReturnUndefined = false) => {
